   ...
   <div className = "contact-body">
       <Grid className = "contact-grid">
           <Cell col={6}>
               ...
               style = {{height:'250px'}}
               />
               <p style = {{width : '750px', margin : 'auto',paddingTop:'1em'}}>
                asdhkghakjfgkafghkdjhgkdfhglkhksajghkhakadjfgksdhksdlhgksjhgskjghsklhgslk
                 Wile bullshit may reach its apogee in the political 
                <br/>this is not a course on political bullshit. 
                 Instead, we will focus on bullshit that comes clad in the trappings of scholarly discourse. Traditionally, 
                 such highbrow nonsense has come couched in big words and fancy rhetoric, but more and more we see it presented instead in the guise of release for some big pharma company?
        ...
        <List>
    <ListItem>
    <ListItemContent style ={{fontSize:'25px',fontFamily :'cursive'}}>
        <i className = "fa fa-phone-square" aria-hidden ='true' />(+98) 918-504-5121</ListItemContent>
    </ListItem>
    <ListItem>
    <ListItemContent style ={{fontSize:'25px',fontFamily :'cursive'}}>
        <i className = "fa fa-envelope" aria-hidden ='true' />sina.j372@gmail.com</ListItemContent>
    </ListItem>
    <ListItem>
    <ListItemContent style ={{fontSize:'25px',fontFamily :'cursive'}}>
        <i className = "fa fa-skype" aria-hidden ='true' />skypeid</ListItemContent>
    </ListItem>
            </List>
        </div>
